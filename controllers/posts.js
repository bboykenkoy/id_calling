                                ...
                                if (e) {
                                    ...
                                    getInformationPost(req.body.posts_id, function(resultPost) {
                                        ...
                                        getInformationUser(req.body.users_key, function(result) {
                                            ...
                                            //     tinnhan = {
                                            //         to: '<'+result.email+'>',
                                            //         subject: 'Thank you for reported',
